...
ggsave("figs/fig-04-01.pdf", width = 8, height = 6)
...
ggsave("figs/fig-04-02.pdf", width = 8, height = 6)
...
ggsave("figs/fig-04-03.pdf", width = 8, height = 6)
...
p <- ggplot(data = d, aes(x = variable, y = value, shape = treat, color = treat)) +
       ...
       labs(x = "Durée de suivi (heure)", y = "Température (°C)")
ggsave("figs/fig-04-04.pdf", width = 8, height = 6)
...
ggsave("figs/fig-04-05.pdf", width = 8, height = 6)
...
cairo_pdf("figs/fig-04-06.pdf", width = 8, height = 6)
plot_grid(p1, p2)
dev.off()
...
ggsave("figs/fig-04-07.pdf", width = 8, height = 6)
